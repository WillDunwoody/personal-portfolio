...
export default function About() {
  ...
  const langId = ['html5', 'css3', 'javascript', 'ruby', 'rails', 'postgresql', 'github', 'react', 'bootstrap']
  return (
        ...
        <div className="language-text">
          <div className="language-container">
            {languages.map((language, index) => {
              console.log(langId[index])
              return (
                <img src={language} className="language trans" id={langId[index]}/>
              )
            })}
          </div>
        </div>
